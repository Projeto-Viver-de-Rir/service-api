...
2. Go to the src/Institutional.Api folder and run ``dotnet run``, or, in visual studio set the api project as startup and run as console/docker/IIS.
...
- Container support with [docker](src/Institutional.Api/dockerfile) and [docker-compose](docker-compose.yml)
...
- Now, depending on your OS, you have different commands:
    1. For windows: ``dotnet ef migrations add InitialCreate --startup-project .\src\Institutional.Api\ --project .\src\Institutional.Infrastructure\``
    2. For linux/mac: ``dotnet ef migrations add InitialCreate --startup-project ./src/Institutional.Api/ --project ./src/Institutional.Infrastructure/``
