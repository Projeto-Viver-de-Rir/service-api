        ...
        services.AddSwaggerGen(c =>
        {
            c.SwaggerDoc("v1",
                new OpenApiInfo
                {
                    ...
                    Version = "v1",
                    Description = "API to interact with all the management and daily operations of an institution",
                    Contact = new OpenApiContact
                    {
                        Name = "Lucas Felipe Kaspary",
                        Url = new Uri("https://github.com/lucasfok")
                    },
                    License = new OpenApiLicense
                    {
                        Name = "MIT",
                        Url = new Uri("https://github.com/Projeto-Viver-de-Rir/service-api/blob/main/LICENSE")
                    }
                });
