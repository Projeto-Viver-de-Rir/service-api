...
namespace Boilerplate.Infrastructure.Migrations
{
    ...
    [Migration("20240521045625_CoordinatorsForScheduleEventsAndEvents")]
    partial class CoordinatorsForScheduleEventsAndEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Boilerplate.Domain.Entities.EventCoordinator", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Domain.Entities.ScheduleEventCoordinator", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Domain.Entities.EventCoordinator", b =>
                {
                    b.HasOne("Boilerplate.Domain.Entities.Event", null)
                        .WithMany("Coordinators")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Boilerplate.Domain.Entities.Volunteer", "Volunteer")
                        .WithMany()
            ...
            modelBuilder.Entity("Boilerplate.Domain.Entities.ScheduleEventCoordinator", b =>
                {
                    b.HasOne("Boilerplate.Domain.Entities.ScheduleEvent", null)
                        .WithMany("Coordinators")
