...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, Guid>, IContext, IDataProtectionKeyContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfigurationsFromAssembly(typeof(ReportDebtConfiguration).Assembly);
        builder.ApplyConfigurationsFromAssembly(typeof(ReportPresenceConfiguration).Assembly);
    }
}