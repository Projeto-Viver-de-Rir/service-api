...
namespace Institutional.Infrastructure.Migrations
{
    ...
    [Migration("20240929141859_ScheduleEventRelationWithEvent")]
    partial class ScheduleEventRelationWithEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Institutional.Domain.Entities.ReportDebt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ReportDebts");
                });

            modelBuilder.Entity("Institutional.Domain.Entities.ReportPresence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("LastMonthAttendance")
                        .HasColumnType("integer");

                    b.Property<int>("PreviousMonthAttendance")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Institutional.Domain.Entities.TeamMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Institutional.Domain.Entities.TeamMember", b =>
                {
                    b.HasOne("Institutional.Domain.Entities.Team", null)
                        .WithMany("Members")
